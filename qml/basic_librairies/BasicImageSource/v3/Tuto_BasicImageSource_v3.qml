...
SceneAbstract {
    ...
    BasicImageSource {
        ...
        onVisibleAndReady: {
            console.log()
            console.log("pBasicImageSource is ready --> " + mBasicDisplay.getmDimensions(pBasicImageSource))
        }
    ...
    BasicImageSource {
        ...
        onVisibleAndReady: {
            console.log()
            console.log("pBasicImageSourceTer is ready --> " + mBasicDisplay.getmDimensions(pBasicImageSource))
        }
    }
    ...
    BasicImageSource {
        ...
        onVisibleAndReady: {
            console.log()
            console.log("pBasicImageSourceBis is ready --> " + mBasicDisplay.getmDimensions(pBasicImageSource))
        }
    }
    ...
    BasicImageSource {
        ...
        onVisibleAndReady: {
            console.log()
            console.log("pBasicImageSourceHover is ready --> " + mBasicDisplay.getmDimensions(pBasicImageSource))
        }
