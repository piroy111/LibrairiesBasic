...
BasicItem {
    ...
    property list<BasicChatLine> mListBasicChatLine;
    ...
    function createLines() {
        ...
        for (let lIdx = 0; lIdx < lArrayLines.length; lIdx++) {
            ...
            if (lLine !== "") {
                let lBasicChatLine = lComponentBasicChatLine.createObject(mTHIS_BASIC_CHAT_V2);
                /*
    ...
    function positionAndSizeLines() {
        ...
        for (let lIdx = 0; lIdx < mListBasicChatLine.length; lIdx++) {
            ...
            lBasicChatLine.yPercent = lYPercent
            lBasicChatLine.textFontPixelSizePercent = textFontPixelSizePercent;
            lBasicChatLine.widthPercent = widthOneChatMaxPercent
            ...
            if (lChatter == 0) {
                ...
                lBasicChatLine.xPercent = 1 - lBasicChatLine.width / width
            } else {
