...
BasicItem {
    ...
    function adjustWindow() {
        mBasicDisplay.errorOverride(mTHIS_BASICTEXT_V3, "adjustWindow");
    }
    ...
    Rectangle {
        ...
        Rectangle {
          ...
          Default values
          */
            color: mTHIS_BASICTEXT_V3.backgroundColor
            radius: mTHIS_BASICTEXT_V3.parentHeight * mTHIS_BASICTEXT_V3.radiusInteriorPctHeight
            // width: mBorder.width - 2 * Math.ceil(mTHIS_BASICTEXT_V3.borderWidthPercent * mTHIS_BASICTEXT_V3.parentWidth)
            // height: mBorder.height - 2 * Math.ceil(mTHIS_BASICTEXT_V3.borderWidthPercent * mTHIS_BASICTEXT_V3.parentWidth)
            opacity: backgroundOpacity
            ...
            AppText {
                ...
                z: mTHIS_BASICTEXT_V3.z

                visible: mTHIS_BASICTEXT_V3.visible

                /*
                  Text
                  */
                text: mTHIS_BASICTEXT_V3.text
                color: textColor
                opacity: textOpacity
                ...
                font.pixelSize: {
                    if (textFontForceSizePixel > 0) {
                        ...
                        if (textFontPixelSizePercentMax > 0) {
                            return Math.ceil(Math.min(textFontPixelSizePercentMax, textFontPixelSizePercent) * mTHIS_BASICTEXT_V3.parentHeight);
                        } else {
                            return Math.ceil(textFontPixelSizePercent * mTHIS_BASICTEXT_V3.parentHeight);
                        }
                    }
                }
    ...
    function startBumpText() {
        mThisNumberAnimationTextBump.to = Math.ceil(textFontPixelSizePercent * mTHIS_BASICTEXT_V3.parentHeight)
    ...
    function startBumpFullWindow() {
        ...
        mThisSubAnimeText.from = Math.ceil(textFontPixelSizePercent * 0.1 * mTHIS_BASICTEXT_V3.parentHeight);
        mThisSubAnimeText.to = Math.ceil(textFontPixelSizePercent * mTHIS_BASICTEXT_V3.parentHeight);
    ...
    function shadow_getmTHIS_BASICTEXT_V3WindowText_width() {
        return mTHIS_BASICTEXT_V3WindowText.width;
    }
    function shadow_getmTHIS_BASICTEXT_V3WindowText_height() {
        return mTHIS_BASICTEXT_V3WindowText.height;
    }
    function shadow_getmTHIS_BASICTEXT_V3WindowText() {
        return mTHIS_BASICTEXT_V3WindowText
    }
